...
#             objects have:
#                radius, center, __name__
#
#     f. What does a RoseWindow RENDER method do?
#            It stops the screen for a number of seconds after other shapes are drawn.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When you want to stop further code from being read until a user input is received,
#            since the script will keep running with the window open otherwise.
#
