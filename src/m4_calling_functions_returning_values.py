...
def run_test_sum_of_digits():
    ...
    # ------------------------------------------------------------------
    # 2: DONE Implement this TEST function, as follows:
    #
    ...
    # Test 2:
    expected = 7
    answer = sum_of_digits(1312)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 18
    answer = sum_of_digits(549)
...
def run_test_digits_in_cube():
    ...
    # ------------------------------------------------------------------
    # 3: DONE Implement this function.
...
def run_test_digits_in_power():
    ...
    # ------------------------------------------------------------------
    # 5: DONE Implement this function.
    ...
    # Test 2:
    expected = 18   # 12^3 and 12^4 have the same sum of digits - interesting!
    ...
    # Test 3:
    expected = 1
    answer = digits_in_power(123456789, 0)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_fancy_sums_of_digits():
    ...
    # ------------------------------------------------------------------
    # 7: DONE Implement this function.
